...
def inject_translations():
    translations_dict = {
        'en': {
            ...
            'onboard_tags_heading': 'Tags & Filtering',
            'onboard_tags': 'Tag your recipes and filter by tags to quickly find what you\'re looking for.',
            'onboard_cart_heading': 'Shopping Cart',
            'onboard_cart': 'Add recipes to your cart, adjust portions, and copy aggregated ingredient lists for your next grocery run.',
        ...
        'de': {
            ...
            'onboard_tags_heading': 'Tags & Filtern',
            'onboard_tags': 'Markieren Sie Ihre Rezepte mit Tags und filtern Sie danach, um schnell zu finden, was Sie suchen.',
            'onboard_cart_heading': 'Einkaufswagen',
            'onboard_cart': 'Fügen Sie Rezepte zu Ihrem Warenkorb hinzu, passen Sie Portionen an und kopieren Sie die zusammengefasste Zutatenliste für Ihren nächsten Einkauf.',
        ...
        'ru': {
            ...
            'onboard_tags_heading': 'Теги и фильтрация',
            'onboard_tags': 'Добавляйте теги к рецептам и фильтруйте по ним, чтобы быстро находить то, что нужно.',
            'onboard_cart_heading': 'Корзина покупок',
            'onboard_cart': 'Добавляйте рецепты в корзину, меняйте порции и копируйте общий список ингредиентов для следующего похода в магазин.',
